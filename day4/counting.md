...
<img src="{{ "/assets/images/sam_bam_1.png" | relative_url }}" width="600px" alt="alignment_star1">
...
Before using SAMtools, load it as a module:
...
~~~
# Let's cd into the mapped directory first
...
# Alignments with a maximal mapping quality score (255 for STAR output files) are truly unique.

samtools view -q 255 -c Arabidopsis_sample1.bam
...
/standard/bims6000/bin/featureCounts -O -t gene -g ID -a /standard/bims6000/data/morning/ath_annotation.gff3 -o counts.txt mapped/*.bam
~~~
{: .language-bash}
