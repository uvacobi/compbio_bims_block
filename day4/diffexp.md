...
[2] "/sfs/gpfs/tardis/applications/202506/software/standard/mpi/gcc/11.4.0/openmpi/4.1.4/R/4.4.1/lib64/R/library"
~~~
{: .output}
...
<img src="{{ "/assets/images/volcano_plot.tiff" | relative_url }}" width="800px" alt="default volcano plot" >
...
~~~
{: .language-r}
<img src="{{ "/assets/images/publication_ready_volcano_plot.tiff" | relative_url }}" width="800px" alt="customized volcano plot" >
...
<img src="{{ "/assets/images/mtcars_heatmap.tiff" | relative_url }}" alt="basic heatmap" height="400px">
...
<img src="{{ "/assets/images/normalized_count_heatmap.png" | relative_url }}" alt="first heatmap version" height="400px">
...
<img src="{{ "/assets/images/scaled_count_heatmap.png" | relative_url }}" width="400px" alt="second heatmap (scaled)"  >
...
<img src="{{ "/assets/images/clustered_count_heatmap.png" | relative_url }}" alt="third heatmap version (clustered)" height="400px">
